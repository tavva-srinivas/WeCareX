                            ...
                            onPressed: () async {
                              await DoctorsRecord.collection
                                  ...
                                  .set(createDoctorsRecordData(
                                    doctorName: _model.textController1.text,
                                    specialisation: _model.textController2.text,
                                    experience: int.tryParse(
                                        _model.textController3.text),
                                    availability: _model.textController4.text,
                                    hospitalName: _model.textController4.text,
                                    uid: currentUserUid,
                                  ));

                              context.pushNamed(PatientsinfoWidget.routeName);
                            },
                            text: 'Submit',
