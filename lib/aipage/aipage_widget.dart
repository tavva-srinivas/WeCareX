  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<MessagesRecord>>(
      stream: queryMessagesRecord(
        ...
        queryBuilder: (messagesRecord) => messagesRecord.orderBy('timestamp'),
      ),
      builder: (context, snapshot) {
        ...
        List<MessagesRecord> aipageMessagesRecordList = snapshot.data!;
            ...
            appBar: AppBar(
              ...
              actions: [
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(200.0, 5.0, 10.0, 5.0),
                    child: InkWell(
                      splashColor: Colors.transparent,
                      focusColor: Colors.transparent,
                      hoverColor: Colors.transparent,
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  _model.apiResult =
                                      await GitHubModelsAPICall.call(
                                    userMessage:
                                        _model.userInputTextController.text,
                                  );
