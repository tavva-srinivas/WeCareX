                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await PatientRecord.collection
                                  .doc()
                                  .set(createPatientRecordData(
                                    patientName: _model.textController1.text,
                                    patientsAge: int.tryParse(
                                        _model.textController2.text),
                                    patientsGender: _model.textController3.text,
                                    phoneNo: _model.textController4.text,
                              ...
                              _model.chatId = ChatRecord.getDocumentFromData(
                                  createChatRecordData(), chatRecordReference);
                              FFAppState().ChatID = _model.chatId?.reference;
                              safeSetState(() {});

                              context.pushNamed(AipageCopyWidget.routeName);
